...
using HostTruthHealthReport = VAL.Host.Services.TruthHealthReport;
...
namespace VAL.App.Host.Services
{
    internal sealed class TruthHealthReportService : ITruthHealthReportService
    {
        ...
        private static HostTruthHealthReport ToSnapshotReport(ContinuumTruthHealthReport report)
        {
            return new HostTruthHealthReport(
                report.ChatId,
                report.Bytes,
